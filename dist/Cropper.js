...
const Cropper = React.forwardRef(({ src, crop, onCropChange, onCropComplete, format = "file", cropBoxType = "square", }, ref) => {
    ...
    const triggerCropComplete = () => {
        ...
        if (ctx) {
            ...
            if (format === "base64") {
                ...
                onCropComplete === null || onCropComplete === void 0 ? void 0 : onCropComplete(base64);
            }
                ...
                canvas.toBlob((blob) => {
                    if (blob) {
                        if (format === "file") {
                            ...
                            onCropComplete === null || onCropComplete === void 0 ? void 0 : onCropComplete(file);
                        }
                        else {
                            onCropComplete === null || onCropComplete === void 0 ? void 0 : onCropComplete(blob);
                        }
                    }
                }, "image/png");
            }
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("img", { ref: imageRef, src: src, alt: "To Crop", style: { width: "100%", height: "auto", display: "block" }, onLoad: handleImageLoad }),
        React.createElement("div", { style: {
            ...
            }, onMouseDown: handleMouseDown }, ["top-left", "top-right", "bottom-left", "bottom-right"].map((dir) => (React.createElement("div", { key: dir, style: Object.assign(Object.assign(Object.assign({ position: "absolute", width: 20, height: 20, backgroundColor: "transparent", display: "flex", alignItems: "center", justifyContent: "center" }, (dir.includes("top") ? { top: -10 } : { bottom: -10 })), (dir.includes("left") ? { left: -10 } : { right: -10 })), { cursor: dir === "top-left"
                    ? "nwse-resize"
                    : dir === "top-right"
                        ? "nesw-resize"
                        : dir === "bottom-left"
                            ? "nesw-resize"
                            : "nwse-resize" }), onMouseDown: (e) => handleResizeMouseDown(e, dir) },
            React.createElement("div", { style: {
                    width: "12px",
                    height: "12px",
                    borderTop: "2px solid #035FFE",
                    borderLeft: "2px solid #035FFE",
                    transform: dir === "top-right"
                        ? "rotate(90deg)"
                        : dir === "bottom-left"
                            ? "rotate(-90deg)"
                            : dir === "bottom-right"
